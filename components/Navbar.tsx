        ...
        {status === "loading" ? (
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="text-xs text-gray-500 dark:text-gray-400 hover:text-neon-primary transition-colors"
            >
              Sign out
            </button>
          </div>
          ...
          <Link
            href="/login"
            className="px-4 py-2 rounded-lg bg-neon-secondary text-neon-soft text-xs font-medium no-underline hover:opacity-90 transition-opacity"
          >
            Sign in
          </Link>
        )}
